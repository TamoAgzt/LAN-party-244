...
pageOverlay.addEventListener ('click',() => {
 ...
 //pop up screen 1
    const popUps = document.querySelectorAll('.popup-info.page-active'); 
    popUps.forEach(popUp => {
        closePupUp(popupInfo);
    })
    /**pop uo sceen 2 */
    //pop up screen 2
    const popUps2 = document.querySelectorAll('.popup-info2.page-active'); 
    popUps2.forEach(popUp2 => {
        closePupUp(popupInfo2);
    })
     // pop up screen 3
     const popUps3 = document.querySelectorAll('.popup-info3.page-active'); 
